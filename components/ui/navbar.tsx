...
export const Navbar = ({ links, name, socialMedia }: NavbarProps) => {
  return (
    <nav className="navbar bg-base-100 shadow-sm border-b border-accent">
      <div className="navbar-start">
        ...
        <Link
          href="/"
          className="hidden lg:flex btn btn-ghost md:text-4xl font-oswald"
        >
          {name}
        </Link>
      </div>
      ...
      <div className="navbar-end">
        <Link href="/" className="lg:hidden btn btn-ghost text-xl font-oswald ">
          {name}
        </Link>
